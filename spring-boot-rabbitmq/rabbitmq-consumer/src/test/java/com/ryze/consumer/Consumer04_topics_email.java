...
public class Consumer04_topics_email {
    private final static Logger logger = LoggerFactory.getLogger(Consumer04_topics_email.class);
    /*
    ...
    public static void main(String[] args) {
        ...
        try {
             ...
             */
            channel.queueBind(QUEUE_EMAIl, EXCHANGE_TOPICS, "message.#.email.#");
            /*
    ...
    private static Consumer getDefaultConsumer(Channel channel) {
        return new DefaultConsumer(channel) {
            ...
            public void handleDelivery(String consumerTag, Envelope envelope, AMQP.BasicProperties properties, byte[] body) throws IOException {
                ...
                logger.info("Consumer04_topics_email receive message=" + s);
            }
        };
    }
}
