...
public class Consumer04_topics_sms {
    private final static Logger logger = LoggerFactory.getLogger(Consumer04_topics_sms.class);
    /*
    ...
    public static void main(String[] args) {
        ...
        try {
             ...
             */
            channel.queueBind(QUEUE_SMS, EXCHANGE_TOPICS, "message.#.sms.#");
            /*
    ...
    private static Consumer getDefaultConsumer(Channel channel) {
        return new DefaultConsumer(channel) {
            ...
            public void handleDelivery(String consumerTag, Envelope envelope, AMQP.BasicProperties properties, byte[] body) throws IOException {
                ...
                logger.info("Consumer04_topics_sms receive message=" + s);
            }
        };
    }
}
